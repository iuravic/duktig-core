...
return function($container) {
    ...
    $container->factory(
        'Twig_Environment',
        /**
         * $paths variable for Twig_Environment is given so that Application template dir
         * comes before Core template dir when trying to render templates.
         */
        function(\Duktig\Core\Config\ConfigInterface $config) {
